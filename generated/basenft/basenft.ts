...
export class basenft extends ethereum.SmartContract {
  static bind(address: Address): basenft {
    return new basenft("basenft", address);
  }

  MAX_PER_TRANSACTION(): BigInt {
    let result = super.call(
      "MAX_PER_TRANSACTION",
      "MAX_PER_TRANSACTION():(uint256)",
      [],
    );
  ...
  try_MAX_PER_TRANSACTION(): ethereum.CallResult<BigInt> {
